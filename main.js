...
function myKeyDown(e)
{
	...
	function left()
	{
		if(ball_x >5)
		{
			...
			console.log("Quando a tecla direcional esquerda é pressionada, Y = " + ball_y + " , X = "+ball_y);
			canvas.remove(ball_obj);
			newImage();
	...
	function right()
	{
		if(ball_x <=1050)
		{
			...
			ball_x = ball_x + block_image_width;
			console.log("Largura da imagem do bloco t = " + block_image_width);
			console.log("Quando a tecla direcional direita é pressionada, Y = " + ball_y + " , X = "+ball_y);
			canvas.remove(ball_obj);
			newImage();
		}
	}
